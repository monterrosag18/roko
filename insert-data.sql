-- ===========================================
-- INSERT DATA for db_megastore_exam
-- Extracted from Excel: PM-prueba-desempeno-data_m4
-- ===========================================

USE db_megastore_exam;

-- ===========================================
-- 1. Categories (5 registros)
-- ===========================================
...
-- ===========================================
-- 4. Products (21 registros)
-- category_id y supplier_id se basan en el orden de inserción arriba
-- Categories: 1=Electronics, 2=Accessories, 3=Home, 4=Stationery, 5=Kitchen
-- Suppliers: 1=TechDistro, 2=Accesorios Total, 3=MueblesYa, 4=GamerZone, 
...
('LPT-HP-001', 'Laptop HP Pavilion 15', 3500000.00, 1, 1),
('MSE-LOG-001', 'Mouse Logitech G203', 120000.00, 2, 2),
('USB-KIN-64', 'USB Kingston 64GB', 45000.00, 2, 2),
('CHR-ERG-005', 'Silla Ergonomica Office', 450000.00, 3, 3),
('MON-SAM-24', 'Monitor Samsung 24', 600000.00, 1, 1),
('KBD-MEC-002', 'Teclado Mecanico Redragon', 250000.00, 2, 4),
('DSK-STD-100', 'Escritorio Estandar Blanco', 320000.00, 3, 3),
('LMP-LED-001', 'Lampara LED Escritorio', 80000.00, 3, 5),
('HDP-SNY-005', 'Audifonos Sony WH-1000', 1200000.00, 2, 6),
('TAB-APP-009', 'iPad Air 64GB', 2800000.00, 1, 1),
('CS-TAB-009', 'Funda iPad Air', 90000.00, 2, 2),
('MON-LG-27', 'Monitor LG 27 UltraGear', 1100000.00, 1, 1),
('CBL-HDMI-003', 'Cable HDMI 2.0 3m', 35000.00, 2, 7),
('SF-LIV-002', 'Sofa Cama Gris', 1500000.00, 3, 3),
('PRT-EPS-004', 'Impresora Epson EcoTank', 950000.00, 1, 8),
('PPR-RSM-500', 'Resma Papel Carta 500', 25000.00, 4, 9),
('SPK-JBL-005', 'Parlante JBL Flip 6', 550000.00, 1, 6),
('CFT-OST-001', 'Cafetera Oster 12 Tazas', 180000.00, 5, 10),
('BTR-IMU-002', 'Batidora Inmersion', 120000.00, 5, 10),
('MIC-SHR-058', 'Microfono Shure SM58', 450000.00, 1, 6),
('MKR-SHR-012', 'Marcadores Sharpie x12', 35000.00, 4, 9);
